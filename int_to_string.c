 ...
 * @num: numbr to convert to string
 ...
 * @base: base of numbr representation used by buffer
 ...
 * @num: numbr to convert to string given base
 * @base: base of numbr used in conversion, only works up to base 36
 * @buff: buff to fill with result of conversion
 * @buff_size: size of buf in bytes
 * Return: always void.
 */
void fill_numbase_buff(unsigned int num, unsigned int base,
			char *buff, int buff_size)
